        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                @if(Session::has('client'))
                    <li class="nav-item active"><a href="{{URL::to('/client_logout')}}" class="nav-link"><span class="fas fa-user"></span>Logout</a></li>
                @else
                    <li class="nav-item active"><a href="{{URL::to('/client_login')}}" class="nav-link"><span class="fas fa-user"></span>Login</a></li>
                @endif
